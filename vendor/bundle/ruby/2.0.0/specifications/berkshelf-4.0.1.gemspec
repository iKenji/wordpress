...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<berkshelf-api-client>, ["~> 2.0"])
      ...
      s.add_runtime_dependency(%q<ridley>, ["~> 4.3"])
      ...
      s.add_dependency(%q<berkshelf-api-client>, ["~> 2.0"])
